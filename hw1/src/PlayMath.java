...
public class PlayMath
{
    public static void main(String args[]) throws IOException
    {
        ...
        System.out.println("The maximum of the two numbers is: " + Math.max(n1, n2));
        
        // print the remainder of n1 divided by n2
        System.out.println("The remainder of n1 divided by n2 is: " + (n1 % n2));
        ...
        System.out.println("The value of n1 divided by n2, rounded to the closest integer is: " + Math.round(n1 / n2));
        ...
        System.out.println("The minimum of the square root of n1 and the average of n1 and n2 is: "
                + Math.min(Math.sqrt(n1), (n1+n2)/2));
        
        // print the area of a circle having a diameter of n1 + n2
        double circleArea = Math.PI * Math.pow(n1+n2,2)/4;
        System.out.println("The area of a circle having a diameter of n1 + n2 is: " + circleArea);
        System.out.println("\n\n");
         ...
         *
         *BufferedReader    A line with the first end point at (40, 40) and the second at (45, 45).
         * 
        ...
        double firstSlope = getSlope(new Point(40,40), new Point(45,45));
        System.out.println("The slope of the first line is " + firstSlope);
        
        double secondSlope = getSlope(new Point(80, 120), new Point(100, 40));
        System.out.println("The slope of the second line is " + secondSlope);
        
        double thirdSlope = getSlope(new Point(250, 50), new Point(150, 75));
        System.out.println("The slope of the third line is " + thirdSlope);
        
        double fourthSlope = getSlope(new Point(75, 88), new Point(50, 88));
        System.out.println("The slope of the fourth line is " + fourthSlope);
     ...
     *  (y2 - y1) / (x2 - x1)
     *
     * Hint: you are calling the method form your main() - what does this tell you about the signature?
     */
    
    public static double getSlope(Point firstPoint, Point secondPoint)
    {
